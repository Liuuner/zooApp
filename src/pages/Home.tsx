    ...
    return (
        <div>
            ...
            <Paper className={"newsPaper"}>
                <a href={"https://www.zoo.ch/de/zoonews/zwei-neue-im-regenwald"}><img id={"news1Img"} src="../../public/Vogel.png" /></a>
                <h3 className={"imageText"}>ZWEI NEUE IM REGENWALD</h3>
            </Paper>
            <Paper className={"newsPaper"}>
                <a href={"https://www.zoo.ch/de/zoonews"}><img id={"news2Img"} src="../../public/KaTierHalt.png"/></a>
